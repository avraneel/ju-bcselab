...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        save_to_file->setGeometry(QRect(140, 10, 89, 25));
        ...
        redo_btn->setGeometry(QRect(260, 10, 89, 25));
        ...
        undo_btn->setGeometry(QRect(380, 10, 89, 25));
        ...
        replace_word->setGeometry(QRect(250, 40, 111, 25));
        ...
        find_btn->setGeometry(QRect(130, 40, 91, 25));
        find_btn->setFocusPolicy(Qt::ClickFocus);
        clear = new QPushButton(centralwidget);
        clear->setObjectName(QString::fromUtf8("clear"));
        clear->setGeometry(QRect(490, 10, 91, 21));
